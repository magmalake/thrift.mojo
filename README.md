...
published at
[magmalake.github.io/thrift.mojo/benchmarks](https://magmalake.github.io/thrift.mojo/benchmarks/).
...
Note that the compiled package (`.mojoc`, formerly `.mojopkg`) is built with stable Mojo 1.0.0 and the
